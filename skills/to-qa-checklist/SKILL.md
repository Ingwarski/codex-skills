...
description: Use when approved SDD product and UX artifacts exist and the user wants a QA checklist, acceptance checks, accessibility checks, responsive checks, visual regression checks, or release-readiness criteria.
---
# to-qa-checklist
...
9. Create or update only `docs/qa-checklist.md`.
